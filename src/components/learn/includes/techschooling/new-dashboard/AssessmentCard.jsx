...
function AssessmentCard({ data, index, activeLesson, setActiveLesson }) {
  // const minutes = Math.floor(data.assessment_data.duration / 60);
  // const seconds = Math.floor(data.assessment_data.duration % 60);
        ...
        <LeftSection>
          <SkillName>
            ...
            <DesignationCover>
              ...
              {data.assessment_data.skill_name}
            </DesignationCover>
          </SkillName>
          <TopicName>{data.assessment_data.title}</TopicName>
        </LeftSection>
        <RightSection>
          <ThumnailImage>
            <img src={data.assessment_data.image} alt="Video thumnail" />
  ...
  return (
    <>
      {data.status === "locked" ? (
        ...
        <Container
          to={`/nanodegree/${slug}/assessments/view/${data.assessment_data.id}/`}
