...
function PracticeCard({ data, index, activeLesson, setActiveLesson }) {
  // const minutes = Math.floor(data.practice_data.duration / 60);
  // const seconds = Math.floor(data.practice_data.duration % 60);
        ...
        <LeftSection>
          <SkillName>
            ...
            <DesignationCover>
              ...
              {data.practice_data.skill_name}
            </DesignationCover>
          </SkillName>
          <TopicName>{data.practice_data.title}</TopicName>
        </LeftSection>
        <RightSection>
          <ThumnailImage>
            <img src={data.practice_data.image} alt="Video thumnail" />
            {/* {data.practice_data.status == "" ? ( */}
            <LockImage>
              <img
  ...
  return (
    <>
      {data.status === "locked" ? (
        ...
        <Container
          to={`/nanodegree/${slug}/practices/view/${data.practice_data.id}`}
