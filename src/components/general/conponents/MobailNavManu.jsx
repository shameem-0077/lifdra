...
function MobailNavManu({}) {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      active_icon:
        "https://s3.ap-south-1.amazonaws.com/talrop.com-react-assets-bucket/assets/images/28-11-2024/g740.svg",
      arrow_icon: "",
    },
  ];
  ...
  if (auth.isAuthenticated()) {
    menuItems.push({
      ...
      active_icon:
        "https://s3.ap-south-1.amazonaws.com/talrop.com-react-assets-bucket/assets/images/27-11-2024/bell-03.svg",
      arrow_icon: "",
    });
  }
      ...
      <Head>
        <Container>
          {menuItems.map((item, index) => (
            <MenuBox to={item.path} key={index}>
              <ItemIconContainer>
                <img
                  src={
