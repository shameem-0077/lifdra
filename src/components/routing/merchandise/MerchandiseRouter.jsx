    ...
    <>
      <Suspense fallback={<RouteLoading />}>
        <Container id="main" className={divMainClass}>
          ...
          <MerchandiseFilter isModal={isModal} setIsModal={setIsModal} />
          ...
          <Switch>
            ...
            <Route exact path="/merchandise/my-orders/" component={MyOrders} />
            <Route
              exact
              path="/merchandise/buy-now/products/:product_id/"
              component={BuyNow}
            />
            <Route exact path="/merchandise/my-cart/" component={MyCart} />
            <Route
              exact
